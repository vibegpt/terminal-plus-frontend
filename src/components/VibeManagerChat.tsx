...
const vibePrompts: Record<string, string> = {
  ...
  Shop: "Respond with enthusiasm for shopping and browsing. Suggest interesting stores, deals, and unique finds. Encourage exploration of retail and gift options."
};
...
export default function VibeManagerChat() {
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      const systemPrompt = `${vibePrompts[vibe] || vibePrompts["Chill"]} The user is currently feeling: ${mood || "unknown"}. ${contextPrompt} Respond with empathy and personalized support.`;
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
          <div className="bg-white dark:bg-slate-900 rounded-xl shadow-2xl p-8 w-80 flex flex-col items-center">
            ...
            <div className="flex flex-col gap-3 w-full mb-4">
              {['Chill', 'Explore', 'Work', 'Quick', 'Shop'].map((option) => (
                <button
                  key={option}
