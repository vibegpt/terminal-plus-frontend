...
import type { CategoryCarouselsProps } from "@/types/ui.types";
import type { Amenity } from "@/types/amenity.types";

// Local interface for this component's specific needs
interface CategoryAmenity extends Omit<Amenity, 'vibe_tags'> {
  vibe_tags?: string[];
...
const CategoryCarousels: React.FC<CategoryCarouselsProps> = ({ amenities, terminal, vibe, onAmenityClick, className }) => {
  // Group amenities by category, filter by terminal
  const grouped = React.useMemo(() => {
    const byCat: Record<string, CategoryAmenity[]> = {};
    for (const amenity of amenities as CategoryAmenity[]) {
