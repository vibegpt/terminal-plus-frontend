...
export const SimilarUsersRecommendations: React.FC<SimilarUsersRecommendationsProps> = ({
  currentVibe,
  userPreferences = [],
  airportCode,
  terminal,
  ...
  const mockRecommendations: SimilarUserRecommendation[] = [
    {
      id: '1',
      title: 'Coffee Corner',
      description: '12 people with similar vibe preferences loved this spot',
    ...
    },
    {
      id: '2',
      title: 'Quiet Lounge',
      description: '8 people who chose chill vibes found this relaxing',
    ...
    },
    {
      id: '3',
      title: 'Work Pod',
      description: '6 people with work vibes highly recommend this space',
      location: 'Work Pod',
      terminal: 'T3',
      vibe: 'work',
      similarUserCount: 6,
    ...
    },
    {
      ...
      description: '10 people who value speed found this efficient',
        ...
        <CardHeader>
          <CardTitle className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              ...
              <span>Similar Users Recommend</span>
            </div>
            <div className="flex items-center space-x-2">
