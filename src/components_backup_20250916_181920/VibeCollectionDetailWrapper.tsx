...
const VibeCollectionDetailWrapper: React.FC = () => {
  ...
  // For now, we'll use the collectionSlug as the collectionId
  // In the future, we could use the vibe parameter for additional context
  return <CollectionDetailSmart7 collectionId={collectionSlug} />;
};

export default VibeCollectionDetailWrapper;
