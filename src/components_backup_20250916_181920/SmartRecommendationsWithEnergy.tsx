...
const exampleAmenities: Amenity[] = [
  ...
  },
  {
    ...
    price_tier: "$$$",
    accessibility: true,
    opening_hours: { "Monday-Sunday": "09:00-21:00" }
  },
  {
    id: "5",
    name: "Adventure Zone",
    ...
    location: "Terminal 1",
    terminal_code: "SIN-T1",
    vibe_tags: ["explore", "work"],
    price_tier: "$$",
    accessibility: false,
    opening_hours: { "Monday-Sunday": "10:00-20:00" }
  }
];

const SmartRecommendationsWithEnergy: React.FC = () => {
  ...
  const userContext: UserContext = useMemo(() => ({
    ...
    preferences: {
      ...
      accessibility: true,
      maxWaitTime: 30,
      preferredCategories: ["Food & Dining", "Lounge", "Spa & Wellness"]
    },
    constraints: {
  ...
  // Transform energy suggestion to match EnergySuggestionCard format
  const transformedEnergySuggestion = useMemo(() => {
    ...
    return {
      ...
      showOverride: !energyOverridden
    };
  }, [energySuggestion, energyOverridden]);
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      <h2 className="text-2xl font-bold mb-6">Smart Recommendations with Energy</h2>
      ...
      <div className="text-sm text-gray-600">
        ...
        <p>Energy Overridden: {energyOverridden ? 'Yes' : 'No'}</p>
        <p>Selected Energy: {selectedEnergyLevel || 'None'}</p>
...
export default SmartRecommendationsWithEnergy; 