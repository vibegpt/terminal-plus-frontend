  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center p-6 min-h-screen">
        ...
        <span className="ml-2">Loading your starting point...</span>
      </div>
    );
  }
    ...
    return (
      <div className="p-6 text-center max-w-md mx-auto">
        <div className="bg-white dark:bg-slate-800 rounded-lg p-6 shadow-md">
          <h1 className="text-2xl font-bold mb-4">Journey Error</h1>
  ...
  return (
    <div className="p-6 flex flex-col items-center text-center max-w-md mx-auto">
      ...
      <div className="bg-white dark:bg-slate-800 shadow-lg rounded-lg p-6 w-full mb-8">
        <h2 className="text-xl font-semibold mb-4">{currentStop.name}</h2>
      ...
      <Button
        ...
        className="px-6 py-3 bg-gradient-to-r from-purple-600 to-indigo-600 text-lg"
      >
        View Full Journey ➔
      </Button>
    </div>
