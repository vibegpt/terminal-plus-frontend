      ...
      <div className="p-4 space-y-4">
        ...
        <div className="bg-white dark:bg-slate-800 rounded-lg p-6 shadow-md">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-2xl font-bold">{selectedJourney.flight_number}</h2>
          ...
          <div className="mb-6">
            ...
            <div className="flex items-center justify-between mt-1">
              <div className="text-xl font-bold">{selectedJourney.origin}</div>
              <ArrowRight className="h-5 w-5 text-slate-400" />
              <div className="text-xl font-bold">{selectedJourney.destination}</div>
            </div>
        ...
        <div className="p-4 bg-primary-50 dark:bg-slate-900 rounded-lg mt-4">
          <h3 className="font-medium mb-2">Terminal Tips ({selectedJourney.selected_vibe})</h3>
