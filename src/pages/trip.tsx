  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center min-h-screen">
        ...
        <p className="ml-2 text-lg">Loading shared trip plan...</p>
      </div>
    );
  }
  ...
  if (error || !tripData) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen p-6 text-center">
        ...
        <p className="text-gray-700">{error || "Trip not found or invalid link"}</p>
        <a 
          href="/"
  ...
  return (
    <div className="p-6">
      <div className="max-w-5xl mx-auto">
        <h1 className="text-2xl font-bold text-center mb-6">Shared Trip Plan</h1>
