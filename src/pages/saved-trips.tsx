...
export default function SavedTrips() {
  ...
  if (isLoading) {
    return (
      <div className="flex items-center justify-center min-h-screen">
        ...
        <p className="ml-2 text-lg">Loading your saved trips...</p>
      </div>
    );
  }
  ...
  if (trips.length === 0) {
    return (
      <div className="p-6 text-center">
        <h1 className="text-2xl font-bold mb-6">📂 Your Saved Trips</h1>
        <p className="text-gray-600 mb-6">No saved trips yet.</p>
        <button
          onClick={() => setLocation("/")}
  ...
  return (
    <div className="p-6">
      <h1 className="text-2xl font-bold mb-6 text-center">📂 Your Saved Trips</h1>
          ...
          >
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="bg-red-500 text-white py-1 px-4 rounded hover:bg-red-600 text-sm flex items-center gap-1"
              >
                {isDeleting === trip.id ? (
                  <>
