...
import { checkTransitOrSelfTransfer } from "@/utils";
...
export default function SimplifiedJourneyInput() {
  ...
  return (
    <div className={`flex flex-col min-h-screen p-6 max-w-3xl mx-auto ${pageBgGlowClass}`}>
      <h1 className="text-3xl font-bold mb-8 text-center bg-gradient-to-r from-primary-600 to-secondary-600 dark:from-primary-500 dark:to-secondary-500 text-transparent bg-clip-text">
        Start Your Terminal Journey
      </h1>

      <div className="bg-white dark:bg-slate-800 rounded-lg p-6 shadow-md mb-8">
        <h2 className="text-xl font-medium mb-4 text-slate-900 dark:text-white">Where are you flying from?</h2>
        <div className="grid grid-cols-3 gap-3 mb-4">
          <Button
            variant={airport === "SYD" ? "default" : "outline"}
            onClick={() => handleAirportClick("SYD")}
            className="h-16 bg-white dark:bg-slate-800 text-slate-900 dark:text-white border-slate-200 dark:border-slate-700 hover:bg-slate-100 dark:hover:bg-slate-700"
          >
            Sydney (SYD)
          </Button>
          <Button
        ...
        <div className="flex items-center gap-2 mt-4">
          ...
          <Input 
            ...
            className="max-w-[200px] bg-white dark:bg-slate-800 text-slate-900 dark:text-white border-slate-200 dark:border-slate-700"
          />
        </div>
      </div>

      <div className="bg-white dark:bg-slate-800 rounded-lg p-6 shadow-md mb-8">
        <h2 className="text-xl font-medium mb-4 text-slate-900 dark:text-white">What's your vibe?</h2>
      ...
      <div className="text-center mb-8">
        <Button 
          ...
          className="w-full md:w-auto px-8 py-6 text-lg bg-gradient-to-r from-primary-600 to-secondary-600 dark:from-primary-500 dark:to-secondary-500 text-white hover:from-primary-700 hover:to-secondary-700 dark:hover:from-primary-600 dark:hover:to-secondary-600"
        >
        ...
        <DialogContent className="sm:max-w-md bg-white dark:bg-slate-800 text-slate-900 dark:text-white">
          ...
          <div className="grid gap-4 py-4">
            <div className="space-y-2">
              <label htmlFor="flightNumber" className="text-sm font-medium text-slate-900 dark:text-white">
                Flight Number
              </label>
              <Input
                id="flightNumber"
            ...
            <div className="space-y-2">
              <label htmlFor="destination" className="text-sm font-medium text-slate-900 dark:text-white">
                Destination City
              </label>
              <Input
                id="destination"
