...
import { ChevronRight, MapPin, Wifi, Clock, Sparkles } from 'lucide-react';
...
const VibesFeedMVP: React.FC = () => {
  ...
  // Load collections for each vibe using the new service
          ...
          return (
            ...
            >
              ...
              <div className="relative">
                ...
                {section.collections.slice(0, 7).map((collection, idx) => (
                  <button
