...
export default function PlanJourneyPage() {
  ...
  return (
    <div className={`min-h-screen flex flex-col items-center justify-center ${pageBgGlowClass}`}>
      <div className="max-w-2xl w-full bg-white dark:bg-slate-800 rounded-lg shadow-lg p-8">
        <h1 className="text-2xl font-bold mb-6 text-slate-900 dark:text-white">Plan a New Journey</h1>
        ...
        <div className="flex flex-col space-y-2">
          ...
          <input
            ...
            onChange={(e) => setDepartureTime(e.target.value)}
              className="flex h-9 w-full rounded-md border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 px-3 py-1 text-sm shadow-sm transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-400 dark:focus-visible:ring-primary-500 text-slate-900 dark:text-white"
            required
          />
        </div>
