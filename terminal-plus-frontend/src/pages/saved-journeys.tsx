...
export default function SavedJourneys() {
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center p-6 min-h-screen bg-white dark:bg-slate-900">
        ...
        <span className="ml-2 text-slate-900 dark:text-white">Loading your saved journeys...</span>
      </div>
    );
  }
    ...
    return (
      <div className="p-6 text-center max-w-md mx-auto bg-white dark:bg-slate-900">
        <div className="bg-white dark:bg-slate-800 rounded-lg p-6 shadow-md">
          <h1 className="text-2xl font-bold mb-4 text-center text-slate-900 dark:text-white">Your Saved Journeys</h1>
          <p className="text-slate-600 dark:text-slate-400 mb-6">
            No saved journeys found. Plan your next airport adventure!
          </p>
          <Button
            onClick={handlePlanNew}
            className="w-full bg-gradient-to-r from-purple-600 to-indigo-600 dark:from-purple-500 dark:to-indigo-500 text-white hover:from-purple-700 hover:to-indigo-700 dark:hover:from-purple-600 dark:hover:to-indigo-600"
          >
            Plan New Journey
          </Button>
        </div>
  ...
  return (
    <div className="p-6 max-w-2xl mx-auto bg-white dark:bg-slate-900">
      <div className="bg-white dark:bg-slate-800 rounded-lg p-6 shadow-md mb-6">
        <h1 className="text-2xl font-bold mb-6 bg-gradient-to-r from-purple-600 to-indigo-600 dark:from-purple-500 dark:to-indigo-500 text-transparent bg-clip-text">
        ...
        <div className="space-y-4">
          {savedJourneys.map((journey) => (
            <div
              key={journey.id}
              className="border border-slate-200 dark:border-slate-700 p-4 rounded-lg hover:shadow-md transition bg-white dark:bg-slate-800"
            >
              <div className="flex items-center justify-between mb-2">
                <div>
                  <h3 className="font-semibold text-slate-900 dark:text-white">{journey.airport} {journey.terminal}</h3>
                ...
                <div className="flex">
                  <Button
                    ...
                    className="bg-gradient-to-r from-green-600 to-emerald-600 dark:from-green-500 dark:to-emerald-500 text-white hover:from-green-700 hover:to-emerald-700 dark:hover:from-green-600 dark:hover:to-emerald-600 text-sm"
                    size="sm"
                  >
                    View Journey
                  </Button>
      ...
      <div className="text-center">
        <Button
          onClick={handlePlanNew}
          variant="outline"
          className="text-primary-600 dark:text-primary-400 border-primary-600 dark:border-primary-400 hover:bg-primary-50 dark:hover:bg-slate-700"
        >
          Plan a New Journey
        </Button>
      </div>
